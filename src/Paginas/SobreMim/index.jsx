...
import fotoSobreMim from "/assets/AlbericoJr.jpg"
  ...
  return (
    <PostModelo fotoCapa={fotoCapa} titulo="Sobre mim">
      ...
      <h3 className={styles.subtitulo}>
        Olá, eu sou o Albérico
      </h3>

      <img className={styles.fotoSobreMim} src={fotoSobreMim} alt="Foto do Albérico Junior sorrindo" />
